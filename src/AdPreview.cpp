...
bool AdPreview::setup() {
      ...
      // @geode-ignore(unknown-resource)
      auto announcementButtonSprite = CCSprite::createWithSpriteFrameName("geode.loader/news.png");
      auto announcementButton = CCMenuItemSpriteExtra::create(
          announcementButtonSprite,
          this,
          menu_selector(AdPreview::onAnnouncementButton));
      announcementButton->setPosition({m_mainLayer->getContentSize().width - 17, 18});
      menu->addChild(announcementButton);
